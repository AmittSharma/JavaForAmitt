...
public class Casting {
    ...
    public static void main ( String[] args ) {
        /*SYNTAX RULES*/
        short myMinShortValue = Short.MIN_VALUE; int myMinIntValue = Integer.MIN_VALUE; // can declare multiple var of diff types separated by ;
        byte myMinByteValue = Byte.MIN_VALUE, getMyMaxByteValue = Byte.MAX_VALUE; // can declare multiple var of same type separated by ,
